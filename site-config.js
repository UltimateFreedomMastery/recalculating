...
const siteConfig = {
  ...
  clusters: [
    {
      ...
      description: "How perception, identity, and experience are produced"
    },
    {
      id: "stability",
      label: "Staying stable under pressure",
      description: "What happens when identity activates — and how to hold structure"
    },
    {
      id: "love",
      label: "Understanding conflict, compassion, and care",
      description: "How identity shapes relationship, moral clarity, and connection"
    },
    {
      id: "freedom",
      label: "Exploring what freedom actually is",
      description: "Beyond recognition — what it takes for the architecture to change"
    }
  ],
  ...
  pieces: [
...

    {
      ...
      featured: false,
      featuredOrder: null,
      recommendedNext: null,  // terminal piece — no single obvious next step
